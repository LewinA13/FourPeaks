...
namespace gfx
{
    ...
    // draw sprite with multiply tint
    void drawSpriteTinted(AEGfxTexture* tex, Vec2 position, f32 rotationRad, Vec2 size, f32 u0, f32 v0, f32 u1, f32 v1, u32 multiplyColor);
}
